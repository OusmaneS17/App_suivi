...
urlpatterns = [
    ...
    path('tables/messages/', views.messages_data_view, name='tables_sub5'),
    ...
    path('probleme/<int:pk>/supprimer/', views.supprimer_probleme, name='supprimer_probleme'),
    path('ajout_message/', views.ajouter_message, name='ajout_message'),
    path('modifie_message/<str:rk>', views.modifie_message, name='modifie_message'),
    ...
    path('composante/<int:pk>/supprimer/', views.supprimer_composante, name='supprimer_composante'),
    ...
    path('api/problemes/', views.get_problemes, name='get_problemes'),
]
